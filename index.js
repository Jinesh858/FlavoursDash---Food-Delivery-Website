...
function displayItems(){
    var sandwhich= document.getElementById('sandwhich');
    ...
    const sandwhichData= foodItem.filter((item)=>item.category=='sandwhich');
    const burgerData= foodItem.filter((item)=>item.category=='burger');
    const pizzaData= foodItem.filter((item)=>item.category=='pizza');
    const parathaData= foodItem.filter((item)=>item.category=='paratha');
    ...
    sandwhichData.map(item=>{
        ...
        heart.setAttribute('class','fa-solid fa-plus add-to-cart');
        ...
        sandwhich.appendChild(itemCard);
